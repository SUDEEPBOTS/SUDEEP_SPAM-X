    ...
    if e.sender_id in SUDO_USERS:
        ...
        if len(altron) == 1:
            ...
            if int(e.chat_id) in GROUP:
                await e.reply("» ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪs  ᯓ𓂃❛ 𝗦 𝛖 𝛅 ֟፝ᥱ 𝛆 𝛒 </𝟑 𝁘ໍ𝀛𓂃🍷 ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ.", parse_mode=None, link_preview=None )
            else:
...
async def hang(e):
    ...
    if e.sender_id in SUDO_USERS:
        ...
        if len(mkh) == 1:
            counter = int(mkh[0])
            if int(e.chat_id) in GROUP:
                await e.reply("» ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪꜱ 𝐒𝐓𝐑𝐀𝐍𝐆𝐄𝐑 ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ.", parse_mode=None, link_preview=None)
            else:
